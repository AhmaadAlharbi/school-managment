                        ...
                        <form action="{{route('Exams.update','test')}}" method="post">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="Name_ar" value="{{ $exam->getTranslation('name', 'ar') }}"
                                        class="form-control">
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" name="Name_en" value="{{ $exam->getTranslation('name', 'en') }}"
                                        class="form-control">
                                </div>
                                ...
                                <div class="form-group col">
                                    ...
                                    <select class="custom-select mr-sm-2" name="academic_year">
                                        ...
                                        @for($year=$current_year; $year<=$current_year +1 ;$year++) <option
                                            value="{{$year}}" {{$year==$exam->academic_year ?'selected':''}}>{{ $year }}
                                            </option>
                                            @endfor
                                    </select>
                                </div>
